                ...
                <div className="col-lg-8 mt-sm-5">
                  <div >
                    <table className="table">
                      <thead>
                        <tr >
                          <th className="bg-dark text-white fw-bold " scope="col">أسم القسم</th>
                          <th className="bg-dark text-white fw-bold " scope="col">تعديل</th>
                          <th className="bg-dark text-white fw-bold " scope="col">حذف</th>
                        </tr>
                      </thead>
                      <tbody>
                        {products.map((brand) => (
                          <tr>
                            ...
                            <td className=" fw-bold ">
                              <Link className=" text-decoration-none btn btn-primary" to={`/admin/editcategory/${brand._id}`}>تعديل</Link>
                            </td>
                            <td>
